...
public class AuthenticatedIdPData implements Serializable {
    ...
    public List<AuthenticatorConfig> getAuthenticators() {
        ...
        List<AuthenticatorConfig> authenticatorsToBeReturned = new ArrayList<AuthenticatorConfig>();

        if (this.authenticators != null) {
            authenticatorsToBeReturned = (List<AuthenticatorConfig>) ((ArrayList) this.authenticators).clone();
        }
